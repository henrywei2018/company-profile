        ...
        <div class="grid justify-center md:grid-cols-2 md:justify-between gap-2">
            ...
            <div class="flex items-center justify-end gap-x-3">
                @if (isset($companyProfile->facebook) && $companyProfile->facebook)
                    <a class="size-6 inline-flex justify-center items-center gap-x-2 text-white hover:text-amber-200 dark:hover:text-amber-200"
                        href="{{ $companyProfile->facebook }}" target="_blank" rel="noopener noreferrer">
                ...
                @if (isset($companyProfile->twitter) && $companyProfile->twitter)
                    <a class="size-6 inline-flex justify-center items-center gap-x-2 text-white hover:text-amber-200 dark:hover:text-amber-200"
                        href="{{ $companyProfile->twitter }}" target="_blank" rel="noopener noreferrer">
                        <svg class="size-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            fill="currentColor" viewBox="0 0 16 16">
                            <path
                ...
                @if (isset($companyProfile->linkedin) && $companyProfile->linkedin)
                    <a class="size-6 inline-flex justify-center items-center gap-x-2 text-white hover:text-amber-200 dark:hover:text-amber-200"
                        href="{{ $companyProfile->linkedin }}" target="_blank" rel="noopener noreferrer">
                        <svg class="size-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            fill="currentColor" viewBox="0 0 16 16">
                            <path
                ...
                @if (isset($companyProfile->instagram) && $companyProfile->instagram)
                    <a class="size-6 inline-flex justify-center items-center gap-x-2 text-white hover:text-amber-200 dark:hover:text-amber-200"
                        href="{{ $companyProfile->instagram }}" target="_blank" rel="noopener noreferrer">
                        <svg class="size-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            fill="currentColor" viewBox="0 0 16 16">
                            <path
...
<!-- Main Header -->
<header
    class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-white text-sm sticky top-0 shadow-sm dark:bg-gray-800">
    <nav class="relative max-w-7xl w-full mx-auto px-4 md:flex md:items-center md:justify-between md:px-6 lg:px-8 py-2"
        ...
        <div id="navbar-collapse-with-animation"
            ...
            <div
                ...
                <a href="{{ route('home') }}"
                    class="font-medium text-gray-700 hover:text-amber-600 md:py-6 dark:text-gray-200 dark:hover:text-amber-500 {{ request()->routeIs('home') ? 'text-amber-600 dark:text-amber-500' : '' }}">Home</a>
                <a href="{{ route('about') }}"
                    class="font-medium text-gray-700 hover:text-amber-600 md:py-6 dark:text-gray-200 dark:hover:text-amber-500 {{ request()->routeIs('about*') ? 'text-amber-600 dark:text-amber-500' : '' }}">About</a>
                <a href="{{ route('services.index') }}"
                    class="font-medium text-gray-700 hover:text-amber-600 md:py-6 dark:text-gray-200 dark:hover:text-amber-500 {{ request()->routeIs('services*') ? 'text-amber-600 dark:text-amber-500' : '' }}">Services</a>
                <a href="{{ route('portfolio.index') }}"
                    class="font-medium text-gray-700 hover:text-amber-600 md:py-6 dark:text-gray-200 dark:hover:text-amber-500 {{ request()->routeIs('portfolio*') ? 'text-amber-600 dark:text-amber-500' : '' }}">Portfolio</a>
                <a href="{{ route('blog.index') }}"
                    class="font-medium text-gray-700 hover:text-amber-600 md:py-6 dark:text-gray-200 dark:hover:text-amber-500 {{ request()->routeIs('blog*') ? 'text-amber-600 dark:text-amber-500' : '' }}">Blog</a>
                <a href="{{ route('contact.index') }}"
                    class="font-medium text-gray-700 hover:text-amber-600 md:py-6 dark:text-gray-200 dark:hover:text-amber-500 {{ request()->routeIs('contact*') ? 'text-amber-600 dark:text-amber-500' : '' }}">Contact</a>

                @guest
                    <div class="pt-3 md:pt-0">
                        <a href="{{ route('login') }}"
                            class="inline-flex justify-center items-center gap-x-2 py-2 px-3 text-sm font-semibold rounded-lg border border-transparent bg-amber-600 text-white hover:bg-amber-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                            <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24"
                ...
                @else
                    <div
                        ...
                        <button type="button"
                            class="flex items-center w-full text-gray-700 hover:text-gray-500 font-medium dark:text-gray-200 dark:hover:text-gray-400">
            ...
            <div class="pt-3 md:hidden">
                <button type="button" class="size-8 relative inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                    ...
                    <svg class="block dark:hidden size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
