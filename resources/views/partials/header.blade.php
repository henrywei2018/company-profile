...
<header class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-white text-sm sticky top-0 shadow-sm dark:bg-gray-800">
    ...
    <button type="button" class="hs-dark-mode-active:block hidden hs-dark-mode group flex items-center text-gray-700 hover:text-amber-600 dark:text-gray-200 dark:hover:text-amber-400" data-hs-theme-click-value="light">
        <svg class="flex-shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <button type="button" class="hs-dark-mode-active:hidden block hs-dark-mode group flex w-full items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">
                <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/>
                </svg>
                Switch to dark mode
            </button>
            <button type="button" class="hs-dark-mode-active:block hidden hs-dark-mode group flex w-full items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">
                <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <circle cx="12" cy="12" r="4"/>
                    <path d="M12 2v2"/>
                    <path d="M12 20v2"/>
