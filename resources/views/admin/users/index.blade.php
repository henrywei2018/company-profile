...
<x-layouts.admin title="Users Management">
    ...
    <x-admin.card>
            ...
            @forelse($users as $user)
                <x-admin.table-row>
                    ...
                    <x-admin.table-cell>
                        <div class="flex flex-col space-y-1">
                            ...
                            @if ($user->email_verified_at)
                                <x-admin.badge type="info" size="sm">Verified</x-admin.badge>
                            @else
                    ...
                    <x-admin.table-cell>
                        ...
                        @else
                            <span class="text-sm text-gray-500 dark:text-neutral-500">Never</span>
                        @endif
                    </x-admin.table-cell>
                        ...
                        <div class="relative inline-block text-left">
                            <div>
                                <button type="button"
                                    ...
                                    <svg class="w-4 h-4 text-gray-600 dark:text-neutral-400" fill="currentColor"
                                        viewBox="0 0 20 20">
                                        <path
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12">
                            <x-admin.empty-state title="No users found"
                                ...
                                :actionText="auth()->user()->can('create users') ? 'Create New User' : null" :actionUrl="auth()->user()->can('create users') ? route('admin.users.create') : null" />
                        </td>
                    </tr>
                @endforelse
            </x-admin.data-table>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
            ...
            icon='<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0
