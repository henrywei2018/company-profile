...
<x-layouts.admin :title="'Chat Management'" :enableCharts="true">
    ...
    <div class="mb-6 bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl p-6">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Your Operator Status</h2>
            <div class="flex items-center space-x-3">
                <div class="flex items-center space-x-2">
                    <div id="operator-status-indicator" class="w-3 h-3 rounded-full bg-gray-400"></div>
                    <span id="operator-status-text" class="text-sm text-gray-600 dark:text-gray-400">Checking status...</span>
                </div>
                <button id="toggle-operator-status" 
        ...
        <div class="grid grid-cols-1 sm:grid-cols-4 gap-4">
            <div class="text-center">
                <div class="text-2xl font-bold text-gray-900 dark:text-white" id="current-chats-count">0</div>
                <div class="text-sm text-gray-600 dark:text-gray-400">Current Chats</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-gray-900 dark:text-white" id="todays-chats-count">{{ $statistics['sessions_today'] ?? 0 }}</div>
                <div class="text-sm text-gray-600 dark:text-gray-400">Today's Chats</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-gray-900 dark:text-white" id="avg-response-time">{{ number_format($statistics['avg_response_time'] ?? 0, 1) }}m</div>
                <div class="text-sm text-gray-600 dark:text-gray-400">Avg Response</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-gray-900 dark:text-white" id="satisfaction-rate">{{ number_format($statistics['satisfaction_rate'] ?? 0, 1) }}%</div>
        ...
        <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl">
            ...
            <div class="p-6">
                <div id="waiting-sessions-container" class="space-y-4">
                    ...
                    @empty
                        <div id="no-waiting-sessions" class="text-center py-8">
        ...
        <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl">
            ...
            <div class="p-6">
                <div id="active-sessions-container" class="space-y-4">
                    ...
                    @empty
                        <div id="no-active-sessions" class="text-center py-8">
                            <svg class="mx-auto h-12 w-12 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/>
                            </svg>
    ...
    <div class="mt-8 bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <a href="{{ route('admin.chat.templates') }}" 
    ...
    <script>
        ...
        function updateOperatorStatusUI() {
            ...
            if (operatorOnline && operatorAvailable) {
                ...
                button.className = 'px-4 py-2 text-sm font-medium rounded-lg transition-colors bg-red-600 text-white hover:bg-red-700';
                ...
                button.className = 'px-4 py-2 text-sm font-medium rounded-lg transition-colors bg-green-600 text-white hover:bg-green-700';
            } else {
        ...
        function createSessionElement(session, type) {
            ...
            div.className = 'p-4 border border-gray-200 dark:border-neutral-700 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-700 transition-colors';
        ...
        function showNotification(message, type = 'info') {
            ...
            notification.className = `fixed top-4 right-4 z-50 max-w-sm p-4 rounded-lg shadow-lg border transition-all duration-300 ${getNotificationClasses(type)}`;
