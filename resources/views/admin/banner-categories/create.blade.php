<x-layouts.admin title="Create New Banner Category">
    ...
    <div class="max-w-2xl">
        <form action="{{ route('admin.banner-categories.store') }}" method="POST" class="space-y-6">
            ...
            <!-- Basic Information -->
            <x-admin.form-section title="Category Information" description="Create a new category to organize your banners">
                <div class="space-y-6">
                    <x-admin.input
                        name="name"
                        label="Category Name"
            ...
            <x-admin.form-section title="Usage Examples" description="How to use this category in your templates">
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                    ...
                    <code class="text-sm text-gray-700 dark:text-gray-300 block mb-2">
                        &lt;x-banner-slider categorySlug="<span id="slug-preview">{{ old('slug') ?: 'category-slug' }}</span>" /&gt;
                    </code>
