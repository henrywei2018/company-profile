...
<x-layouts.admin title="Edit Project">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="p-5">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="w-8 h-8 bg-blue-100 dark:bg-blue-800/30 rounded-md flex items-center justify-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $project->progress_percentage ?? 0 }}%</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="w-8 h-8 bg-green-100 dark:bg-green-800/30 rounded-md flex items-center justify-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $project->images->count() }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="w-8 h-8 bg-purple-100 dark:bg-purple-800/30 rounded-md flex items-center justify-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $project->files->count() }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="w-8 h-8 bg-amber-100 dark:bg-amber-800/30 rounded-md flex items-center justify-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $project->milestones->count() }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    @if($project->quotation)
        <div class="bg-blue-50 border border-blue-200 rounded-md p-4 mb-6 dark:bg-blue-900/20 dark:border-blue-800">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800 dark:text-blue-200">Project Created from Quotation</h3>
                    <div class="mt-2 text-sm text-blue-700 dark:text-blue-300">
                        This project was created from 
                        <a href="{{ route('admin.quotations.show', $project->quotation) }}" class="font-medium underline hover:text-blue-600">
    ...
    <form action="{{ route('admin.projects.update', $project) }}" method="POST" enctype="multipart/form-data" id="project-form">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg mb-6">
            <div class="px-4 py-5 sm:p-6">
                <div class="border-b border-gray-200 dark:border-gray-700 pb-4 mb-6">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update the fundamental project details.</p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">URL-friendly version of the title. Leave blank to auto-generate.</p>
                        @error('slug')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="year" id="year" min="1900" max="{{ date('Y') + 5 }}" 
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg mb-6">
            <div class="px-4 py-5 sm:p-6">
                <div class="border-b border-gray-200 dark:border-gray-700 pb-4 mb-6">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage project status, priority, and progress.</p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        <label for="progress_percentage" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Progress (%)</label>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center">
                            ...
                            <label for="featured" class="ml-2 block text-sm text-gray-900 dark:text-white">Featured Project</label>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" name="is_active" id="is_active" value="1" 
                                   ...
                                   class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                            <label for="is_active" class="ml-2 block text-sm text-gray-900 dark:text-white">Active Project</label>
                        </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg mb-6">
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        <label for="estimated_completion_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Estimated Completion</label>
                    ...
                    <div>
                        <label for="actual_completion_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Actual Completion</label>
        ...
        @if(Schema::hasColumn('projects', 'budget') || Schema::hasColumn('projects', 'actual_cost') || Schema::hasColumn('projects', 'value'))
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg mb-6">
            <div class="px-4 py-5 sm:p-6">
                <div class="border-b border-gray-200 dark:border-gray-700 pb-4 mb-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white">Financial Information</h3>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        <label for="value" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Project Value</label>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg mb-6">
            <div class="px-4 py-5 sm:p-6">
                <div class="border-b border-gray-200 dark:border-gray-700 pb-4 mb-6">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Detailed project information and documentation.</p>
                </div>
                
                <div class="space-y-6">
                    <!-- Challenge -->
                    <div>
                        <label for="challenge" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Challenge</label>
                    ...
                    <!-- Result -->
                    <div>
                        <label for="result" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Result</label>
                    ...
                    <div>
                        <label for="client_feedback" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Client Feedback</label>
                    ...
                    <div>
                        <label for="lessons_learned" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Lessons Learned</label>
    ...
    <div class="px-4 py-5 sm:p-6">
        <div class="border-b border-gray-200 dark:border-gray-700 pb-4 mb-6">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Track services and technologies used in this project.</p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Services Used
                    <span class="text-xs text-gray-500">(<span x-text="servicesUsed.length"></span> services)</span>
                </label>
                
                <div class="space-y-3">
                    <template x-for="(service, index) in servicesUsed" :key="'service-' + index">
                        <div class="flex items-center space-x-2 group">
                            <div class="relative flex-1">
                                <input 
                                    type="text" 
                                    :name="'services_used[' + index + ']'" 
                                    x-model="service.value"
                                    placeholder="Enter service name"
                                    class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm 
                                           focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 
                                           dark:bg-gray-700 dark:text-white text-sm
                                           transition-colors duration-200"
                                    @input="validateService(index)"
                                    :class="{ 'border-red-300 focus:border-red-500 focus:ring-red-500': service.error }"
                                >
                                <div x-show="service.error" class="absolute -bottom-5 left-0 text-xs text-red-600" x-text="service.error"></div>
                            </div>
                            ...
                            <button 
                                ...
                                :disabled="servicesUsed.length <= 1"
        ...
        <div class="mt-8">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                Team Members
                <span class="text-xs text-gray-500">(<span x-text="teamMembers.length"></span> members)</span>
            </label>
            
            <div class="space-y-3">
                <template x-for="(member, index) in teamMembers" :key="'member-' + index">
                    <div class="flex items-center space-x-2 group">
                        <div class="relative flex-1">
                            <input 
                                type="text" 
                                :name="'team_members[' + index + ']'" 
                                x-model="member.value"
                                placeholder="Enter team member name"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm 
                                       focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 
                                       dark:bg-gray-700 dark:text-white text-sm
                                       transition-colors duration-200"
                                @input="validateTeamMember(index)"
                                :class="{ 'border-red-300 focus:border-red-500 focus:ring-red-500': member.error }"
                            >
                            <div x-show="member.error" class="absolute -bottom-5 left-0 text-xs text-red-600" x-text="member.error"></div>
                        </div>
        ...
        <div class="mt-8 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div class="text-sm text-gray-600 dark:text-gray-300">
                ...
                <span x-text="servicesUsed.filter(s => s.value.trim()).length"></span> services,
                <span x-text="technologiesUsed.filter(t => t.value.trim()).length"></span> technologies,
                <span x-text="teamMembers.filter(m => m.value.trim()).length"></span> team members
            </div>
        </div>
    </div>
</div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg mb-6">
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="mb-6">
                    <h4 class="text-md font-medium text-gray-900 dark:text-white mb-4">Current Images ({{ $project->images->count() }})</h4>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4" id="existing-images-grid">
                        ...
                        <div class="relative group image-item" data-image-id="{{ $image->id }}">
                            ...
                            <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition-all duration-200 rounded-lg flex items-center justify-center opacity-0 group-hover:opacity-100">
                                <div class="flex space-x-2">
                                    <button type="button" class="set-featured-btn bg-white text-gray-800 px-3 py-1 rounded-md text-sm font-medium hover:bg-gray-100 {{ $image->is_featured ? 'bg-yellow-400 text-yellow-900' : '' }}"
                                            data-image-id="{{ $image->id }}">
                                        {{ $image->is_featured ? 'Featured' : 'Set Featured' }}
                                    </button>
                                    <button type="button" class="delete-image-btn bg-red-600 text-white px-3 py-1 rounded-md text-sm font-medium hover:bg-red-700"
                                            data-image-id="{{ $image->id }}">
                                        Delete
                                    </button>
                                </div>
                    ...
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md dark:border-gray-600">
                        <div class="space-y-1 text-center">
                            ...
                            <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                <label for="images" class="relative cursor-pointer bg-white dark:bg-gray-700 rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                    <span>Upload images</span>
                                    <input id="images" name="images[]" type="file" class="sr-only" multiple accept="image/*">
                                </label>
                                <p class="pl-1">or drag and drop</p>
                            </div>
                            <p class="text-xs text-gray-500 dark:text-gray-400">PNG, JPG, WebP up to 2MB each (max 10 images)</p>
                        </div>
                    </div>
                    
                    <!-- Image Preview Container -->
                    <div id="image-preview-container" class="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 hidden"></div>
        ...
        @if(Schema::hasColumn('projects', 'meta_title') || Schema::hasColumn('projects', 'meta_description') || Schema::hasColumn('projects', 'meta_keywords'))
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg mb-6">
            <div class="px-4 py-5 sm:p-6">
                <div class="border-b border-gray-200 dark:border-gray-700 pb-4 mb-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white">SEO Information</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Search engine optimization settings.</p>
                </div>
    ...
    <div id="delete-project-modal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
            <div class="mt-3 text-center">
                ...
                <div class="mt-2 px-7 py-3">
                    ...
                    <div class="mt-3 text-left bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md p-3">
    ...
    return {
        ...
        removeService(index) {
            if (this.servicesUsed.length > 1) {
                ...
                this.servicesError = 'At least one service is required.';
            }
        },

        validateService(index) {
            const service = this.servicesUsed[index];
            if (!service) return;
            ...
            if (service.value.trim().length === 0) {
                service.error = 'Service name is required';
                return;
            }

            if (service.value.trim().length > 100) {
                service.error = 'Service name is too long (max 100 characters)';
                return;
            }
            ...
            if (duplicateIndex !== -1) {
                service.error = 'Duplicate service name';
                return;
            }
        },

        validateAllServices() {
            this.servicesUsed.forEach((service, index) => {
        ...
        addTechnology() {
            this.technologiesUsed.push({ value: '', error: null });
            this.technologiesError = null;
            
            this.$nextTick(() => {
                const inputs = this.$el.querySelectorAll('input[name^="technologies_used"]');
                if (inputs.length > 0) {
                    inputs[inputs.length - 1].focus();
                }
            });
        ...
        removeTechnology(index) {
            if (this.technologiesUsed.length > 1) {
                this.technologiesUsed.splice(index, 1);
                this.validateAllTechnologies();
            } else {
                this.technologiesError = 'At least one technology is required.';
            }
        },

        validateTechnology(index) {
            const tech = this.technologiesUsed[index];
            if (!tech) return;

            tech.error = null;
            this.technologiesError = null;

            if (tech.value.trim().length === 0) {
                tech.error = 'Technology name is required';
                return;
            }

            if (tech.value.trim().length > 100) {
                tech.error = 'Technology name is too long (max 100 characters)';
                return;
            }
            ...
            if (duplicateIndex !== -1) {
                tech.error = 'Duplicate technology name';
                return;
            }
        },

        validateAllTechnologies() {
            this.technologiesUsed.forEach((tech, index) => {
                this.validateTechnology(index);
            });
        },

        // Team Members Methods
        addTeamMember() {
            this.teamMembers.push({ value: '', error: null });
            this.teamMembersError = null;
            
            this.$nextTick(() => {
                const inputs = this.$el.querySelectorAll('input[name^="team_members"]');
                if (inputs.length > 0) {
                    inputs[inputs.length - 1].focus();
                }
            });
        ...
        removeTeamMember(index) {
            if (this.teamMembers.length > 1) {
                ...
                this.validateAllTeamMembers();
            } else {
                this.teamMembersError = 'At least one team member is required.';
            }
        },

        validateTeamMember(index) {
            ...
            if (member.value.trim().length === 0) {
                member.error = 'Team member name is required';
                return;
            }

            if (member.value.trim().length > 100) {
                member.error = 'Team member name is too long (max 100 characters)';
                return;
            }
            ...
            if (duplicateIndex !== -1) {
                member.error = 'Duplicate team member name';
                return;
            }
        },
        ...
        initializeData(services = [], technologies = [], members = []) {
            this.servicesUsed = services.length > 0 
                ? services.map(s => ({ value: s || '', error: null }))
                : [{ value: '', error: null }];
                
            this.technologiesUsed = technologies.length > 0 
                ? technologies.map(t => ({ value: t || '', error: null }))
                : [{ value: '', error: null }];
                
            this.teamMembers = members.length > 0 
                ? members.map(m => ({ value: m || '', error: null }))
                : [{ value: '', error: null }];
        },
        ...
        validateAll() {
            ...
            return !hasErrors && !this.servicesError && !this.technologiesError && !this.teamMembersError;
        }
    }
}
