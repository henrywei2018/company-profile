...
<x-layouts.admin title="Edit Project">
    ...
    <form action="{{ route('admin.projects.update', $project) }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg mb-6">
            <div class="px-4 py-5 sm:p-6">
                <div class="border-b border-gray-200 dark:border-gray-700 pb-4 mb-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white">Services & Technologies
                    </h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Track services and technologies used in
                        this project.</p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div id="services-container" class="space-y-2">
                            @if (!empty($project->services_used) && count($project->services_used) > 0)
                                @foreach ($project->services_used as $index => $service)
                                    <div class="service-item flex items-center space-x-2">
                                        <input type="text" name="services_used[]" value="{{ $service }}"
                                            class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white text-sm">
                                        <button type="button" onclick="removeServiceItem(this)"
                                            class="p-2 text-red-600 hover:text-red-800 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md">
                            ...
                            @else
                                <div class="service-item flex items-center space-x-2">
                                    <input type="text" name="services_used[]" value=""
                        ...
                        <button type="button" onclick="addServiceItem()"
                            class="mt-3 inline-flex items-center px-3 py-2 text-sm font-medium text-indigo-600 hover:text-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded-md">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <!-- Technologies Used -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Technologies
                            Used</label>
                        <div id="technologies-container" class="space-y-2">
                            @if (!empty($project->technologies_used) && count($project->technologies_used) > 0)
                                @foreach ($project->technologies_used as $index => $tech)
                                    <div class="tech-item flex items-center space-x-2">
                                        <input type="text" name="technologies_used[]" value="{{ $tech }}"
                                            class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white text-sm">
                                        <button type="button" onclick="removeTechItem(this)"
                                            class="p-2 text-red-600 hover:text-red-800 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            @else
                                <div class="tech-item flex items-center space-x-2">
                                    <input type="text" name="technologies_used[]" value=""
                        ...
                        <button type="button" onclick="addTechItem()"
                            class="mt-3 inline-flex items-center px-3 py-2 text-sm font-medium text-indigo-600 hover:text-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded-md">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                ...
                <div class="mt-6">
                    ...
                    <div id="team-members-container" class="space-y-2">
                        @if (!empty($project->team_members) && count($project->team_members) > 0)
                            @foreach ($project->team_members as $index => $member)
                                <div class="member-item flex items-center space-x-2">
                                    <input type="text" name="team_members[]" value="{{ $member }}"
                                        class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white text-sm">
                                    <button type="button" onclick="removeMemberItem(this)"
                                        class="p-2 text-red-600 hover:text-red-800 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <button type="button" onclick="addMemberItem()"
                        class="mt-3 inline-flex items-center px-3 py-2 text-sm font-medium text-indigo-600 hover:text-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded-md">
                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
...
function addServiceItem() {
    ...
    const template = `
        <div class="service-item flex items-center space-x-2">
            <input type="text" name="services_used[]" value="" placeholder="Enter service name"
                   class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white text-sm">
            <button type="button" onclick="removeServiceItem(this)" 
                    class="p-2 text-red-600 hover:text-red-800 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function addTechItem() {
    ...
    const template = `
        <div class="tech-item flex items-center space-x-2">
            <input type="text" name="technologies_used[]" value="" placeholder="Enter technology name"
                   class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white text-sm">
            <button type="button" onclick="removeTechItem(this)" 
                    class="p-2 text-red-600 hover:text-red-800 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function addMemberItem() {
    ...
    const template = `
        <div class="member-item flex items-center space-x-2">
            <input type="text" name="team_members[]" value="" placeholder="Enter team member name"
                   class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white text-sm">
            <button type="button" onclick="removeMemberItem(this)" 
                    class="p-2 text-red-600 hover:text-red-800 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function removeMemberItem(button) {
    const container = document.getElementById('team-members-container');
    if (container.children.length > 1) {
