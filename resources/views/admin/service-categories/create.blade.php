...
<x-layouts.admin title="Add New Service Category" :unreadMessages="$unreadMessages" :pendingQuotations="$pendingQuotations">
    <!-- Header -->
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <x-admin.breadcrumb :items="[
            'Service Categories' => route('admin.service-categories.index'),
            'Add New Category' => route('admin.service-categories.create'),
        ]" />
    </div>
    ...
    <form action="{{ route('admin.service-categories.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <!-- Basic Information -->
        <x-admin.form-section title="Category Information" description="Enter the basic details of the service category.">
