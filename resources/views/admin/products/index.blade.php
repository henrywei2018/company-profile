                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2">
                                ...
                                @if($product->is_featured)
                                    <span class="inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-800 dark:text-yellow-100">
                            ...
                            @if($product->sku || $product->brand)
                                <div class="mt-1 flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                                    @if($product->sku)
                                        <code class="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs">
                                            SKU: {{ $product->sku }}
                                        </code>
                                    @endif
                                    @if($product->brand)
