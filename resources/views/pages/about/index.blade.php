...
<x-layouts.public
    title="About Us - {{ $siteConfig['site_title'] }}"
    :description="$companyProfile->about ?? 'Learn more about our company.'"
    keywords="about us, company profile, team, vision, mission"
    type="website"
>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-orange-600 md:ml-2 font-medium">About Us</span>
                    </div>
                </li>
            </ol>
        </nav>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600">The professionals behind our success</p>
        </div>
