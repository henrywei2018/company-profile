...
<x-dynamic-component :component="$layout"  title="Edit Profile">
    <div class="py-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- Header -->
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Your Profile</h1>
                        ...
                        <x-admin.card>
                            <div class="flex flex-col space-y-3">
                                ...
                                >
                                    ...
                                    <span x-show="isFormValid">Update Profile</span>
                                </x-admin.button>
