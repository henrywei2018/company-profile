...
<x-layouts.admin title="Message Details" :unreadMessages="0" :pendingQuotations="0">
    <!-- Header -->
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        ...
        <div class="mt-4 md:mt-0 flex flex-wrap gap-2">
            ...
            @if($message->project)
                <x-admin.button
                    href="{{ route('client.messages.project', $message->project) }}"
                    color="light"
                    size="sm"
                >
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <div class="flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            @if($message->project)
                                <span>•</span>
                                <a href="{{ route('client.projects.show', $message->project) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                                        ...
                                        <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                                @foreach($threadMessage->attachments as $attachment)
                                                    <a
                                                        href="{{ route('client.messages.attachment.download', [$threadMessage, $attachment]) }}"
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <x-admin.card>
                ...
                <div class="space-y-3 text-sm">
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium {{ $message->is_replied ? 'text-green-600 dark:text-green-400' : 'text-orange-600 dark:text-orange-400' }}">
                    ...
                    @if($message->project)
                        <div class="flex justify-between">
                            ...
                            <a href="{{ route('client.projects.show', $message->project) }}" class="font-medium text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 truncate">
                                {{ $message->project->title }}
                            </a>
                        </div>
                    @endif
                ...
                <div class="space-y-3">
                    @foreach($relatedMessages as $related)
                        <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-md">
                            <a href="{{ route('client.messages.show', $related) }}" class="text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                    ...
                    @if($relatedMessages->count() === 5)
                        <div class="text-center pt-2">
                            <a href="{{ route('client.messages.project', $message->project) }}" class="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
            ...
            <x-admin.card>
                ...
                <div class="space-y-2">
                    ...
                    @if($message->project)
                        <x-admin.button
                            href="{{ route('client.projects.show', $message->project) }}"
                            color="light"
                            size="sm"
                            class="w-full"
                        >
...
function showUpdateNotification() {
    ...
    notification.className = 'fixed top-4 right-4 p-4 bg-blue-100 border border-blue-200 text-blue-800 rounded-md shadow-lg z-50';
