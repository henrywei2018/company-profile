// File: resources/views/components/admin/universal-file-uploader.blade.php
...
<div 
    ...
    class="universal-file-uploader {{ $containerClass }}"
    id="{{ $componentId }}"
>
    <!-- Main Drop Zone -->
    <div 
                ...
                <div class="relative bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition-shadow">
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-shrink-0">
                            <div class="w-12 h-12 rounded-lg flex items-center justify-center" :class="getFileIcon(file.type || file.file_type)">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center space-x-2 mt-2">
                                <!-- Preview Button -->
                                <button v-if="allowPreview && previewEndpoint" 
    ...
    <div x-show="files.length > 0" x-transition class="mt-8">
        ...
        <!-- Upload Options -->
        <div v-if="!autoUpload && (enableCategories || enableDescription || enablePublicToggle)" class="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-6">
