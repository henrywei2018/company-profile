...
<div class="analytics-kpi-dashboard" id="kpi-dashboard">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    ...
                    <div id="export-menu"
                        ...
                        <div class="py-1">
                            <button onclick="exportKPIData('pdf')"
                                class="block w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                Export as PDF
                            </button>
                            <button onclick="exportKPIData('excel')"
                                class="block w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                Export as Excel
                            </button>
                            <button onclick="exportKPIData('csv')"
                                class="block w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                Export as CSV
                            </button>
                        </div>
    ...
    <div class="mb-8">
        <div class="border-b border-gray-200 dark:border-gray-700">
            <nav class="-mb-px flex space-x-8" aria-label="KPI Categories">
                <button onclick="switchKPICategory('traffic')" id="tab-traffic"
                ...
                <button onclick="switchKPICategory('engagement')" id="tab-engagement"
                ...
                <button onclick="switchKPICategory('conversion')" id="tab-conversion"
                    class="kpi-tab whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm focus:outline-none transition-colors">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <button onclick="switchKPICategory('audience')" id="tab-audience"
                    class="kpi-tab whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm focus:outline-none transition-colors">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <button onclick="switchKPICategory('acquisition')" id="tab-acquisition"
                    class="kpi-tab whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm focus:outline-none transition-colors">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <button onclick="switchKPICategory('behavior')" id="tab-behavior"
                    class="kpi-tab whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm focus:outline-none transition-colors">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <button onclick="switchKPICategory('technical')" id="tab-technical"
                    class="kpi-tab whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm focus:outline-none transition-colors">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="kpi-category-content">
        ...
        <!-- Traffic KPIs -->
        <div id="traffic-content" class="kpi-category active" style="display: block;">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div
                    ...
                    <div class="relative" style="height: 300px;">
                        <canvas id="channel-distribution-chart" width="400" height="300"></canvas>
                    </div>
                </div>

                <!-- Traffic Trends -->
                <div
                    class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 lg:col-span-2">
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Traffic Trends</h4>
                    <div class="relative" style="height: 400px;">
                        <canvas id="traffic-trends-chart" width="800" height="400"></canvas>
                    </div>
                </div>

                <!-- Traffic Summary Cards (ADDED - missing from original) -->
                <div id="traffic-summary-cards" class="lg:col-span-2 grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <!-- Engagement KPIs -->
        <div id="engagement-content" class="kpi-category" style="display: none;">
            <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <!-- Most Engaging Pages -->
                <div
                    class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 lg:col-span-2 xl:col-span-3">
        ...
        <!-- Conversion KPIs -->
        <div id="conversion-content" class="kpi-category" style="display: none;">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <!-- Conversion Funnel -->
                <div
                    class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <!-- Audience KPIs -->
        <div id="audience-content" class="kpi-category" style="display: none;">
            <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <!-- Acquisition KPIs -->
        <div id="acquisition-content" class="kpi-category" style="display: none;">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <!-- Marketing Channels -->
                <div
                    class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <!-- Behavior KPIs -->
        <div id="behavior-content" class="kpi-category" style="display: none;">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <!-- Most Viewed Pages -->
                <div
                    class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <!-- Technical KPIs -->
        <div id="technical-content" class="kpi-category" style="display: none;">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <!-- Site Speed Metrics -->
                <div
                    class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
    ...
    class KPIDashboard {
        ...
        setupEventListeners() {
            ...
            document.addEventListener('click', (e) => {
                if (!e.target.closest('#export-menu') && !e.target.closest(
                        'button[onclick="toggleExportMenu()"]')) {
        ...
        async loadKPIData(period = this.currentPeriod) {
            try {
                ...
                if (data.success) {
                    ...
                    console.log('KPI Data loaded:', this.kpiData); // Debug log
        ...
        renderKPIDashboard() {
            if (!this.kpiData) {
                console.warn('No KPI data available for rendering');
                return;
            }

            console.log('Rendering KPI Dashboard with data:', this.kpiData);
        ...
        renderOverviewKPIs() {
            const container = this.safeGetElement('overview-kpis');
            if (!container) return;
            ...
            if (Object.keys(overview).length === 0) {
                container.innerHTML =
                    '<div class="col-span-full text-center text-gray-500 py-8">No overview data available</div>';
                return;
            }
        ...
        renderAlerts() {
            const alertsContainer = this.safeGetElement('kpi-alerts');
        ...
        renderCategoryContent(category) {
            ...
            const categoryContent = this.safeGetElement(`${category}-content`);
            if (categoryContent) {
                ...
                console.error(`Category content for '${category}' not found`);
            }
        }

        renderTrafficKPIs() {
            if (!this.kpiData?.traffic) {
                ...
                this.renderChart('traffic-trends-chart', {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            {
                                label: 'Users',
                                data: traffic.user_trend ? traffic.user_trend.map(t => parseInt(t
                                    .value) || 0) : [],
                                borderColor: '#10B981',
            ...
            this.safeSetHTML('traffic-summary-cards', `
            <div class="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                <h5 class="text-sm font-medium text-blue-600 dark:text-blue-400">Organic Traffic</h5>
                <p class="text-xl font-bold text-gray-900 dark:text-white">${traffic.organic_traffic?.sessions || 0}</p>
                <p class="text-xs text-gray-500">${traffic.organic_traffic?.percentage || 0}%</p>
            </div>
            <div class="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                <h5 class="text-sm font-medium text-green-600 dark:text-green-400">Direct Traffic</h5>
                <p class="text-xl font-bold text-gray-900 dark:text-white">${traffic.direct_traffic?.sessions || 0}</p>
                <p class="text-xs text-gray-500">${traffic.direct_traffic?.percentage || 0}%</p>
            </div>
            <div class="text-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                <h5 class="text-sm font-medium text-purple-600 dark:text-purple-400">Referral Traffic</h5>
                <p class="text-xl font-bold text-gray-900 dark:text-white">${traffic.referral_traffic?.sessions || 0}</p>
                <p class="text-xs text-gray-500">${traffic.referral_traffic?.percentage || 0}%</p>
            </div>
            <div class="text-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                <h5 class="text-sm font-medium text-orange-600 dark:text-orange-400">Social Traffic</h5>
                <p class="text-xl font-bold text-gray-900 dark:text-white">${traffic.social_traffic?.sessions || 0}</p>
                <p class="text-xs text-gray-500">${traffic.social_traffic?.percentage || 0}%</p>
            </div>
        `);
        }

        renderEngagementKPIs() {
            if (!this.kpiData?.engagement) {
            ...
            this.safeSetHTML('session-duration-metric', `
        ...
        `);
            ...
            // Bounce Rate Metric
            this.safeSetHTML('bounce-rate-metric', `
            <div class="text-center">
                <div class="text-3xl font-bold text-gray-900 dark:text-white mb-2">
        ...
        `);
            ...
            this.safeSetHTML('pages-per-session-metric', `
            <div class="text-center">
                <div class="text-3xl font-bold text-gray-900 dark:text-white mb-2">
        ...
        `);
            ...
            if (engagement.most_engaging_pages && engagement.most_engaging_pages.length > 0) {
                ...
                this.safeSetHTML('engaging-pages-table',
                    '<p class="text-gray-500 text-center py-4">No engaging pages data available</p>');
            }
        }

        renderConversionKPIs() {
            if (!this.kpiData?.conversion) {
                console.warn('No conversion data available');
                return;
            }
            ...
            if (funnelData.length > 0) {
                this.safeSetHTML('conversion-funnel', `
                <div class="space-y-3">
            ...
            `);
                ...
                this.safeSetHTML('conversion-funnel',
                    '<p class="text-gray-500 text-center py-4">No conversion funnel data available</p>');
            }

            // Top Converting Sources Table
            if (conversion.top_converting_sources && conversion.top_converting_sources.length > 0) {
                ...
                this.safeSetHTML('converting-sources-table',
                    '<p class="text-gray-500 text-center py-4">No converting sources data available</p>');
            }
        }

        renderAudienceKPIs() {
            if (!this.kpiData?.audience) {
                console.warn('No audience data available');
                return;
            }
            ...
            // Countries Chart
            if (audience.geographic_distribution?.top_countries && audience.geographic_distribution.top_countries
                .length > 0) {
                this.renderChart('countries-chart', {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: 'Sessions',
                            data: audience.geographic_distribution.top_countries.map(c => parseInt(c
                                .sessions) || 0),
                            backgroundColor: '#3B82F6'
                        }]
                    },
            ...
            if (audience.device_breakdown?.devices && audience.device_breakdown.devices.length > 0) {
                this.renderChart('devices-chart', {
                    type: 'doughnut',
                    data: {
                        labels: audience.device_breakdown.devices.map(d => d.deviceCategory),
                        datasets: [{
                            data: audience.device_breakdown.devices.map(d => parseInt(d.sessions) ||
                                0),
        ...
        // FIXED: Acquisition KPIs rendering
        renderAcquisitionKPIs() {
            if (!this.kpiData?.acquisition) {
                console.warn('No acquisition data available');
                return;
            }
            ...
            if (acquisition.marketing_channels) {
                ...
                this.renderChart('marketing-channels-chart', {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: 'Sessions',
                            data: Object.values(channels).map(value => parseInt(value) || 0),
                            backgroundColor: '#3B82F6'
                        }]
                    },
                    options: {
            ...
            if (acquisition.user_acquisition?.top_acquisition_sources && acquisition.user_acquisition
                .top_acquisition_sources.length > 0) {
                this.renderTable('acquisition-sources-table', {
                    ...
                    rows: acquisition.user_acquisition.top_acquisition_sources.map(source => [
                        source.source || 'Unknown',
                        (source.totalUsers || 0).toLocaleString(),
                        (source.sessions || 0).toLocaleString(),
                        source.totalUsers > 0 ? (source.sessions / source.totalUsers).toFixed(2) :
                        '0'
                    ])
                });
            } else {
                this.safeSetHTML('acquisition-sources-table',
                    '<p class="text-gray-500 text-center py-4">No acquisition sources data available</p>');
            }
        }
        ...
        renderBehaviorKPIs() {
            if (!this.kpiData?.behavior) {
                console.warn('No behavior data available');
                return;
            }
            ...
            if (behavior.content_performance?.most_viewed_pages && behavior.content_performance.most_viewed_pages
                .length > 0) {
                this.renderTable('most-viewed-pages-table', {
                    ...
                    rows: behavior.content_performance.most_viewed_pages.map(page => [
                        page.pagePath || page.pageTitle || 'Unknown',
                        (page.pageviews || 0).toLocaleString(),
                        (page.uniquePageviews || 0).toLocaleString(),
                        this.formatDuration(page.averageTimeOnPage || 0)
                    ])
                });
            } else {
                this.safeSetHTML('most-viewed-pages-table',
                    '<p class="text-gray-500 text-center py-4">No page views data available</p>');
            }

            // Landing Pages Table
            if (behavior.landing_page_performance?.top_landing_pages && behavior.landing_page_performance
                .top_landing_pages.length > 0) {
                ...
                this.safeSetHTML('landing-pages-table',
                    '<p class="text-gray-500 text-center py-4">No landing pages data available</p>');
            }
        }

        renderTechnicalKPIs() {
            if (!this.kpiData?.technical) {
                console.warn('No technical data available');
                return;
            }
            ...
            this.safeSetHTML('site-speed-metrics', `
            <div class="space-y-4">
                <div class="text-center">
                    <div class="text-3xl font-bold text-gray-900 dark:text-white mb-2">
        ...
        `);
            ...
            if (technical.browser_compatibility?.browser_performance && technical.browser_compatibility
                .browser_performance.length > 0) {
                ...
                this.safeSetHTML('browser-performance-table',
                    '<p class="text-gray-500 text-center py-4">No browser performance data available</p>');
            }
        }

        renderRealtimeSummary() {
        // Simple mock implementation - replace with real real-time data
        this.safeSetHTML('realtime-summary', `
                <div class="text-center">
                ...
                <div class="text-center">
                    <div class="text-2xl font-bold text-gray-900 dark:text-white mb-1">
                        ${this.kpiData?.overview?.sessions?.current || Math.floor(Math.random() * 1000) + 500}
                    </div>
                    <div class="text-sm text-gray-600 dark:text-gray-400">
                        Today's Sessions
                    </div>
                ...
                <div class="text-center">
                    <div class="text-2xl font-bold text-gray-900 dark:text-white mb-1">
                        ${this.kpiData?.overview?.conversions?.current || Math.floor(Math.random() * 50) + 20}
                    </div>
                    <div class="text-sm text-gray-600 dark:text-gray-400">
                        Today's Conversions
                    </div>
        ...
        renderChart(elementId, config) {
            const canvas = this.safeGetElement(elementId);
            if (!canvas) {
            ...
            try {
                ...
                console.error('Chart rendering error for', elementId, ':', error);
        ...
        renderTable(elementId, config) {
            const container = this.safeGetElement(elementId);
            if (!container || !config.headers || !config.rows) {
                console.warn(`Cannot render table for '${elementId}' - missing container or data`);
                return;
            }
            ...
            <div class="overflow-x-auto">
                <table class="kpi-table">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ${config.headers.map(header => `<th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">${header}</th>`).join('')}
                        </tr>
                    </thead>
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ${config.rows.map(row => `
                            <tr>
                                ${row.map(cell => `<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">${cell}</td>`).join('')}
                            </tr>
                        `).join('')}
                    </tbody>
                </table>
        ...
        getTrendClass(trend) {
            const classes = {
                ...
                'stable': 'bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-400'
            };
            return classes[trend] || 'bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-400';
        }
        ...
        showLoadingState() {
            ...
            elements.forEach(id => {
                ...
                if (element) {
                    element.innerHTML = '<div class="flex items-center justify-center py-12"><div class="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div></div>';
                }
            });
        }
        ...
        showMessage(message, type) {
            ...
            toast.className =
                `fixed top-4 right-4 ${bgColor} text-white px-6 py-3 rounded-lg shadow-lg z-50 transition-all duration-300 transform translate-x-full`;
