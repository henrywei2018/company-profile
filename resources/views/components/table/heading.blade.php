...
@props(['sortable' => false, 'field' => '', 'direction' => null])

<th scope="col" {{ $attributes->merge(['class' => 'px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-400']) }}>
    @if($sortable)
