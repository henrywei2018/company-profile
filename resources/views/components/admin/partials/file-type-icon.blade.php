{{-- resources/views/admin/partials/file-type-icon.blade.php --}}
@props(['type'])

@php
$iconClasses = match($type) {
    'image' => 'w-4 h-4 mr-2 text-green-500',
    'document' => 'w-4 h-4 mr-2 text-blue-500',
    'archive' => 'w-4 h-4 mr-2 text-yellow-500',
    default => 'w-4 h-4 mr-2 text-gray-500'
};
@endphp
