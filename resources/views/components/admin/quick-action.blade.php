...
<div id="chat-widget" 
    ...
    <div class="relative">
        ...
        <button @click="toggleChat()" 
                class="{{ $currentSize['button'] }} {{ $currentTheme['button'] }} rounded-full border-2 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 flex items-center justify-center group relative overflow-hidden"
                :class="{ 'rotate-45': isOpen }"
                aria-label="Open chat">
            
            <!-- Chat Icon (when closed) -->
            <svg x-show="!isOpen" 
                 class="{{ $currentSize['icon'] }} transition-all duration-200" 
                 fill="none" 
                 stroke="currentColor" 
                 viewBox="0 0 24 24">
    ...
    <div x-show="isOpen" 
        ...
        <div class="{{ $currentTheme['header'] }} px-4 py-3 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                ...
                <button @click="minimizeChat()" 
                        class="w-6 h-6 rounded-full hover:bg-white hover:bg-opacity-20 flex items-center justify-center transition-colors"
        ...
        <div id="chat-messages" 
            ...
            <div class="flex items-start space-x-3">
                ...
                <div class="flex-1">
                    <div class="{{ $currentTheme['message_operator'] }} rounded-lg rounded-tl-none px-3 py-2 max-w-xs shadow-sm">
                    ...
                    <div class="flex-1">
                        <div class="rounded-lg px-3 py-2 max-w-xs shadow-sm"
                             :class="message.sender === 'user' ? 
                                '{{ $currentTheme['message_user'] }} rounded-tr-none ml-auto' : 
                                '{{ $currentTheme['message_operator'] }} rounded-tl-none'">
            ...
            <form @submit.prevent="sendMessage()">
                <div class="flex items-end space-x-2">
                    ...
                    <button type="button" 
                            ...
                            class="w-8 h-8 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 flex items-center justify-center rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                    ...
                    <button type="submit" 
                            ...
                            class="w-8 h-8 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 dark:disabled:bg-gray-600 text-white rounded-full flex items-center justify-center transition-colors disabled:cursor-not-allowed">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
