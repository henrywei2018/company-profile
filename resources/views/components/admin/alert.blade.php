...
<div 
    ...
    {{ $attributes->merge(['class' => 'p-4 border rounded-lg ' . $typeClasses[$type]]) }}
    role="alert"
>
    <div class="flex">
        @if($icon)
        ...
        <div class="ml-auto pl-3">
            <div class="-mx-1.5 -my-1.5">
                <button 
                    @click="show = false"
                    type="button" 
                    class="inline-flex p-1.5 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 {{ $typeClasses[$type] }}"
                >
