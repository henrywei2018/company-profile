                ...
                <div class="absolute inset-0 flex flex-col justify-center px-12 text-white">
                    <div class="max-w-md">
                        ...
                        <p class="text-xl text-orange-100 mb-8 leading-relaxed">
                            Create a strong, secure password to protect your account and continue your construction journey.
                        </p>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center">
                                ...
                                <span class="text-orange-100">Use 8+ characters</span>
                            </div>
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center mr-3">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span class="text-orange-100">Include letters & numbers</span>
                            </div>
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center mr-3">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span class="text-orange-100">Add special characters</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                    ...
                    <div>
                        <button type="submit" 
                            ...
                            <span class="loading-text">Reset Password</span>
                        </button>
                    </div>
    ...
    <script>
        ...
        function checkPasswordMatch() {
            if (confirmPasswordInput.value && passwordInput.value !== confirmPasswordInput.value) {
                confirmPasswordInput.classList.add('border-red-500', 'ring-2', 'ring-red-200');
                confirmPasswordInput.classList.remove('border-gray-300');
            } else {
                confirmPasswordInput.classList.remove('border-red-500', 'ring-2', 'ring-red-200');
