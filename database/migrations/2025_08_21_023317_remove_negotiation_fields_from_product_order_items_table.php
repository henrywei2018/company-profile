...
return new class extends Migration
{
    ...
    public function down(): void
    {
        Schema::table('product_order_items', function (Blueprint $table) {
            ...
            $table->decimal('proposed_total_price', 15, 2)->nullable();
            $table->decimal('negotiated_unit_price', 15, 2)->nullable();
            $table->decimal('negotiated_total_price', 15, 2)->nullable();
            $table->decimal('final_unit_price', 15, 2)->nullable();
