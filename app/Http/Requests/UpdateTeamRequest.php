...
class UpdateTeamRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'email' => ['nullable', 'email', 'max:255', Rule::unique('team_members', 'email')->ignore($teamMember->id)],
            ...
            'slug' => ['nullable', 'string', 'max:255', Rule::unique('team_members', 'slug')->ignore($teamMember->id)],
